...
<div class="teaching-course-list">
  <section class="teaching-course">
    ...
    <p class="teaching-course__evaluation"><strong>Teaching evaluation:</strong> 4.73/5.</p>
    <p>
    ...
    <ul>
      <li>Developed tutorial sessions, worked examples, review materials, and exam preparation resources.</li>
      <li>Built the POM Tutorials platform to make the course materials easier to navigate and practice with.</li>
    </ul>
  </section>
...
## Teaching Materials & Platforms

<div class="teaching-materials">
  <section class="teaching-material">
    <p class="teaching-material__label">Current platform</p>
    <h3><a href="https://stefanospoulidis.github.io/pom-tutorials/" target="_blank">POM Tutorials</a></h3>
    <p>
      A structured tutorial platform for INSEAD MBA students taking Process &amp; Operations Management, designed to support repeated practice before and after live tutorial sessions.
    </p>
  </section>
</div>
