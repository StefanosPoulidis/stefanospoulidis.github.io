...
require_pattern "assets/css/main.scss" 'font-weight:[[:space:]]*400' "regular-weight author name"
...
require_pattern "assets/css/main.scss" 'padding-left:[[:space:]]*21\.1864406779%' "desktop nav aligns with main text column"
require_pattern "assets/css/main.scss" 'fieldwork-paper' "fieldwork paper grouping styles"
require_pattern "assets/css/main.scss" 'fieldwork-platform' "fieldwork platform link styles"
...
require_pattern "assets/css/main.scss" 'grid-template-columns:[[:space:]]*repeat\(3, minmax\(0, 1fr\)\)' "three-column fieldwork gallery"
reject_pattern "assets/css/main.scss" 'fieldwork-card--newsletter|max-width:[[:space:]]*calc\(\(100% - 1rem\) / 2\)' "removed newsletter second-row styling"
reject_pattern "assets/css/main.scss" 'max-width:[[:space:]]*320px' "old smaller newsletter image width cap"
require_pattern "assets/css/main.scss" 'media-mention-grid' "media mention grid styles"
require_pattern "assets/css/main.scss" 'grid-template-columns:[[:space:]]*repeat\(3, minmax\(0, 1fr\)\)' "three-column media mention grid"
reject_pattern "assets/css/main.scss" 'media-paper-links' "removed related paper link styles"
...
reject_pattern "_pages/about.md" 'Related papers|media-paper-links' "removed related papers row from media mentions"
...
reject_pattern "_pages/teaching.md" 'teaching-platform__facts|5 tutorial sessions|Recordings and slides|Worked practice problems|Past-exam preparation' "removed POM Tutorials feature chips"
reject_pattern "assets/css/main.scss" 'teaching-platform__facts' "removed POM Tutorials feature chip styles"
...
require_pattern "_pages/teaching.md" 'Teaching evaluation:</strong> 4.73/5' "POM teaching evaluation"
