...
require_pattern "assets/css/main.scss" 'fieldwork-card--newsletter' "newsletter fieldwork card"
require_pattern "assets/css/main.scss" 'max-width:[[:space:]]*calc\(\(100% - 1rem\) / 2\)' "newsletter image matches learning gallery column width"
